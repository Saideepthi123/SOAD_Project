      ...
      child: Column(
        children: [
          ...
          FutureBuilder<Object>(
            future: DataService.getMonumentFromCity(userModel.token, cityModel.cityID),
                    ...
                    return Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, idx) {
                          BasicMonument basicMonument=BasicMonument.fromJSON(data[idx]);
                          return InkWell(
                            onTap: () {
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => MonumentPage(monIdx: basicMonument.monumentID,)
                                  )
                              );
                            },
                            child: Card(
