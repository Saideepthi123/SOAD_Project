      ...
      child: Column(
        ...
        children: [
          ...
          isSearch? Container(
            ...
            child: FutureBuilder(
              future: DataService.searchFlights(user.token, _originC.text, _destC.text, depDate),
                                      ...
                                      children: [
                                        RichText(
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(
                                                  text: flight.carrierName, style: TextStyle(
                                                  color: Theme.of(context).primaryColor
                                              ),),
                                            ],
                                          ),
                                        ...
                                        RichText(
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(
                                                  text: flight.minPrice.toString(), style: TextStyle(
                                                  color: Theme.of(context).primaryColor
                                              ),),
                                            ],
                                          ),
