...
class TestPayment(generics.CreateAPIView):
    permission_classes = [IsAuthenticated]
    authentication_classes = [JWTAuthentication, SessionAuthentication]


    stripe.api_key = "sk_test_51Hs6R2DAfuv0xqE2Xf0SHqgscGL2hfkWzAq7jhkKRANGhvX0DcjRwD5E4hhACrRVoBCmaS5XrTtiAt5RnKc1BSQC00GzAtGQtL"
...
class ConfirmIntent(generics.CreateAPIView):
    permission_classes = [IsAuthenticated]
    authentication_classes = [JWTAuthentication, SessionAuthentication]
...
class SavestripeInfo(generics.CreateAPIView):
