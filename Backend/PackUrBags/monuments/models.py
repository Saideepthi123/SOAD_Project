...
class City(models.Model):
    ...
    imageURL=models.TextField(default="https://img.freepik.com/free-vector/cityscape-cartoon-background-panorama-modern-city-with-high-skyscrapers-park-downtown_1441-1982.jpg?size=626&ext=jpg")
...
class Monument(models.Model):
    ...
    pin_code = models.CharField(max_length=6)
    imageURL=models.TextField(default="https://img.freepik.com/free-vector/cityscape-cartoon-background-panorama-modern-city-with-high-skyscrapers-park-downtown_1441-1982.jpg?size=626&ext=jpg")
    in_city = models.ForeignKey(City,on_delete=models.CASCADE,default=1)
